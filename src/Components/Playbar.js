...
export const Playbar = ({ currentSong, isPlaying, setIsPlaying }) => {
    ...
    <div className="playbar">
      ...
      <div className="player-controls">
        <div className="control-buttons">
          <button className="control-btn"><FiShuffle /></button>
          <button className="control-btn"><FiSkipBack className="fill-icon" /></button>
          ...
          <button className="control-btn"><FiSkipForward className="fill-icon" /></button>
          <button className="control-btn"><FiRepeat /></button>
        </div>
